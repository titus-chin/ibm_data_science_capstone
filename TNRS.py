...
Read this [article](https://www.linkedin.com/pulse/torontos-neighborhoods-recommender-system-titus-chin/?trackingId=tdGhWV48QOGKp9NYbQfqoA%3D%3D) to learn how to create such recommender system. Checkout the [GitHub repository](https://github.com/titus-chin/Toronto-Neighborhoods-Recommender-System) for the source code.

Created by:  
[Titus Chin Jun Hong](https://www.linkedin.com/in/titus-chin-jun-hong/)  
28 November 2020  
'''
